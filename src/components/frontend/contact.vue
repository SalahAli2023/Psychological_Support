    ...
    <section class="py-16 bg-white font-almarai">
      <div class="max-w-6xl mx-auto px-6">
        ...
        <div class="grid md:grid-cols-3 gap-6 mb-12">
          ...
          >
            <div
              class="w-14 h-14 flex items-center justify-center rounded-xl bg-gradient-to-tr from-[#9EBF3B] to-[#8aab34] text-white text-2xl"
            >
        ...
        <div>
          ...
          <div class="w-10 h-[2px] bg-[#9EBF3B] mb-6 rounded-full"></div>
          ...
          <form class="space-y-6">
            <div class="grid md:grid-cols-2 gap-4">
              <input
                ...
                class="w-full border border-gray-200 rounded-full px-5 py-3 text-sm text-gray-600 focus:outline-none focus:ring-2 focus:ring-[#9EBF3B] focus:border-transparent transition-all"
              />
              <input
                type="email"
            ...
            <textarea
              ...
              class="w-full border border-gray-200 rounded-xl px-5 py-3 text-sm text-gray-600 focus:outline-none focus:ring-2 focus:ring-[#9EBF3B] focus:border-transparent transition-all"
            ></textarea>

          <div class="flex justify-start">
  <button
    type="submit"
    class="px-8 py-3 rounded-2xl bg-gradient-to-tr from-[#9EBF3B] to-[#8aab34] text-white font-semibold hover:opacity-90 transition-all shadow-md"
  >
    إرسال الرسالة
  </button>
</div>
