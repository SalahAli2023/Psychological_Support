<template>
  <div>
      ...
      <div v-if="showMobileFilter" class="md:hidden bg-white/95 backdrop-blur-lg p-6 rounded-3xl shadow-2xl mb-6 border border-white/30">
        ...
        <div class="flex justify-between items-center mb-6 pb-4 border-b border-gray-200/50">
          <div class="flex items-center gap-3">
            ...
            <div>
              <h3 class="font-bold text-xl text-gray-800">فلاتر البحث</h3>
              <p class="text-sm text-gray-500">اختر الفلاتر المناسبة</p>
            </div>
          </div>
    ...
    <div class="hidden md:block w-full md:w-80 bg-white/95 backdrop-blur-lg p-8 rounded-3xl shadow-2xl border border-white/30 h-fit sticky top-24">
      <!-- الهيدر -->
      <div class="flex justify-between items-center mb-8 pb-6 border-b border-gray-200/50">
        <div class="flex items-center gap-4">
          ...
          <div>
            <h3 class="font-bold text-2xl text-gray-800">تصفية النتائج</h3>
            <p class="text-sm text-gray-500 mt-1">اختر الفلاتر المناسبة</p>
          </div>
        </div>
        <button 
          @click="clearFilters" 
      ...
      <div class="mb-6 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl border border-blue-100">
        <div class="flex justify-between items-center text-sm">
          <span class="text-gray-600 font-medium">الفلاتر المطبقة:</span>
